...
QT_MOC_LITERAL(3, 22, 9) // "wchar_t**"

    },
    "SamuLife\0updateCells\0\0wchar_t**"
};
...
void SamuLife::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->updateCells((*reinterpret_cast< wchar_t**(*)>(_a[1])),(*reinterpret_cast< wchar_t**(*)>(_a[2])),(*reinterpret_cast< wchar_t**(*)>(_a[3])),(*reinterpret_cast< wchar_t**(*)>(_a[4]))); break;
        default: ;
        }
    }
}
